...
#Define the analysis you want to perform at Stage 2
feature.selection1 <- expression(null.model1 <- lm(life_expectancy ~ 1), model2 <- step(null.model1, scope = ~ electricity_access + income_growth + income_growth_pc + children_out_of_school + infant_mortality_rate + primary_completion_rate + real_interest_rate + pop_growth_perc_annual + pop_dens + pop_total + health_expend_pc + health_expend_perc_gdp + unemployment_rate + gdp_growth + gdp_pc + birth_rate + adults_HIV + safe_drinking_water + ed_duration))
