...
```{r, echo = FALSE, include = FALSE}
# Also plot LE, health expenditure pc
...
# Log-transform GDP per capita and health_expend_pc
...
imputations <- mice(LE_data2, seed = 98, # old 231
...
vars <- c("gdp_pc", "health_expend_pc", "adults_HIV",
...
# with NA life expectancy originally. 
...
```{r, echo = FALSE}
# generate predictions for the 19 countries initially missing LE
