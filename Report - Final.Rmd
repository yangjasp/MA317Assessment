...
#Defining the analysis we're performing at Stage 2 (IDK WHICH ONE IS SUPPOSED TO BE STAGE 2 THO)????????????????????????????
...
```{r, echo = FALSE}
# Pooling from above model (maybe we need to specify what is pooling tho.......................................................)
fit <- with(imputations, lm(life_expectancy ~ health_expend_perc_gdp +
                              infant_mortality_rate + safe_drinking_water + gdp_pc))
...
# Recalculate VIF for these five variables only
vif_output <- list()
for (i in 1:10){
